  ...
  return (
    <footer className="bg-secondary dark:bg-on-secondary-fixed w-full rounded-t-[32px] md:rounded-t-[64px] mt-8 md:mt-12 shadow-2xl relative overflow-hidden text-white/90">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/images/footer_accent.png')",
        }}
      />
      ...
      <div className="flex flex-col md:flex-row justify-between items-start max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop pt-12 pb-8 md:pt-16 md:pb-10 gap-8 md:gap-12 relative z-10">
        ...
        <div className="flex flex-col gap-4 max-w-sm">
          <Link href="/" className="text-3xl font-display font-bold text-secondary-fixed">
            MA Links
          </Link>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-6 md:gap-12 w-full md:w-auto">
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link className="text-xs md:text-sm text-white/70 hover:text-white hover:underline transition-all" href="/">
              Home
            </Link>
            <Link className="text-xs md:text-sm text-white/70 hover:text-white hover:underline transition-all" href="/catalog">
              Produce Catalog
            </Link>
            <Link className="text-xs md:text-sm text-white/70 hover:text-white hover:underline transition-all" href="/certifications">
              Registration & Certs
            </Link>
            <Link className="text-xs md:text-sm text-white/70 hover:text-white hover:underline transition-all" href="/quote">
              Request Export RFQ
            </Link>
          </div>
      ...
      <div className="border-t border-white/10 max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-5 flex flex-col sm:flex-row justify-between items-center gap-3 relative z-10 text-[11px] text-white/60">
        ...
        <div className="flex items-center gap-4">
          <Link href="/certifications" className="hover:text-white transition-colors flex items-center gap-1">
