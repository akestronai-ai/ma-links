...
// Read config from process.env (Next.js loads .env automatically)
function getEnvConfig() {
  return {
    host: process.env.SMTP_SERVER || 'smtp.gmail.com',
    port: parseInt(process.env.SMTP_PORT || '465', 10),
    secure: process.env.SMTP_SECURE !== 'false',
    user: process.env.SMTP_USERNAME || 'malinks016@gmail.com',
    pass: process.env.SMTP_PASSWORD || 'adetarrvtgbocamk',
    from: process.env.SMTP_SENDER || 'malinks016@gmail.com',
